...
@interface RLMSyncPermissionResults (SWIFT_EXTENSION(RealmSwift))
/**
  Return the first permission value in the results, or \code
  nil
  \endcode if
  the results are empty.
*/
@property (nonatomic, readonly, strong) RLMSyncPermissionValue * _Nullable first;
/**
  Return the last permission value in the results, or \code
  nil
  \endcode if
  the results are empty.
*/
@property (nonatomic, readonly, strong) RLMSyncPermissionValue * _Nullable last;
@end
