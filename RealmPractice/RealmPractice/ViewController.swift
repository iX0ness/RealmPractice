...
class ViewController: UITableViewController {
    ...
    func setupRealm() {
        ...
        SyncUser.logIn(with: .usernamePassword(username: "mykhaylo.levchuk@ukr.net", password: "613417mL", register: false), server: URL(string: "http://127.0.0.1:9080")!) { user, error in
